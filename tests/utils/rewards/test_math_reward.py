...
from axon.utils.rewards import RewardConfig, RewardOutput, RewardType
from axon.utils.rewards.math_reward import RewardMathFn
...
class TestMathReward:
    ...
    def test_correct_answer_multiple_ground_truths(self):
        ...
        model_response = (
            "<think>The answer could be written as a fraction or decimal</think>\nThe answer is \\boxed{0.5}."
        )
    ...
    def test_numerical_tolerance(self):
        ...
        reward = RewardMathFn(RewardConfig())
        task_info = {
            "problem": "What is π to 5 decimal places?",
            "problem_type": RewardType.MATH,
            "data_source": "test",
    ...
    def test_orm_evaluation(self):
        ...
        task_info = {
            ...
            "problem_type": RewardType.MATH,
            "data_source": "test",
            "ground_truth": "different_but_equivalent_format",
        }
        output = reward(task_info, model_response)
