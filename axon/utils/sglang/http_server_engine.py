...
def launch_server_process(
    ...
    if server_args.node_rank != 0 or not first_rank_in_node:
        logger.info("Server process started with PID %s for node rank %s", p.pid, server_args.node_rank)
        return p
...
class HttpServerAdapter(EngineBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        self.router_ip: str | None = router_ip
        self.router_port: int | None = router_port
    ...
    def release_memory_occupation(self, tags: list[str] | None = None) -> dict[str, Any]:
    ...
    def resume_memory_occupation(self, tags: list[str] | None = None) -> dict[str, Any]:
...
class AsyncHttpServerAdapter(HttpServerAdapter):
    ...
    async def release_memory_occupation(self, tags: list[str] | None = None) -> dict[str, Any]:
    ...
    async def resume_memory_occupation(self, tags: list[str] | None = None) -> dict[str, Any]:
