...
#
# ruff: noqa
# Adapted from https://github.com/tile-ai/tilelang/blob/4956b5835fa554af6c03d4a6289cad44bf310869/examples/deepseek_v32/fp8_lighting_indexer.py (TileLang, MIT License).
import tilelang
import torch
