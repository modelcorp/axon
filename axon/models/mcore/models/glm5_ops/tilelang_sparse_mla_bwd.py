...
#
# ruff: noqa
# Adapted from https://github.com/tile-ai/tilelang/blob/4ff81c7d40803d269569e157e847623e84553f78/examples/deepseek_v32/sparse_mla_bwd.py (TileLang, MIT License).
import tilelang
import torch
