...
from axon.models.mcore.forward.model_forward_fused import _get_final_logit_softcapping
...
def gptmodel_forward_1f1b_overlap(
    ...
    multi_modal_inputs: dict | None = None,  # Not yet supported for 1f1b overlap
    ...
    if multi_modal_inputs and any(v is not None for v in multi_modal_inputs.values()):
        raise ValueError("multi_modal_inputs not supported for 1f1b overlap path")
    ...
    if post_process:
        ...
        def _postprocess(
            ...
            if logits_processor is not None:
                ...
                args = {
                    k: preprocess_packed_seqs(v, attention_mask_out, pre_process=True, use_fp8_padding=use_fp8_padding)[
                        0
                    ]
                ...
                _softcap = _get_final_logit_softcapping(self)
            ...
            # Current 1F1B-overlap path returns only the log-prob tensor.
