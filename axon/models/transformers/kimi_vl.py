...
from axon.utils.transformers_compat import flash_attn_supports_top_left_mask, is_transformers_version_in_range
...
def _ulysses_flash_attn_forward(
    ...
    **kwargs,
    ...
    # Flash Attention expects [batch, sequence, heads, head_dim]. Avoiding these
    # transposes would require a KV-cache layout refactor.
