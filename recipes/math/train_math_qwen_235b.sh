...
# Qwen-235B-A22B Training Script for Math
# Requires 8 nodes with 8 GPUs each (64 GPUs total)
...
# 235B-specific: reduced token length for memory
...
# 235B Hybrid configuration (8 nodes)
...
python3 -m axon.driver.train_agent_ppo \
    ...
    +actor.megatron.override_transformer_config.account_for_embedding_in_pipeline_split=True \
    +actor.megatron.override_transformer_config.account_for_loss_in_pipeline_split=True \
