...
ACTOR_MAX_TOKEN_LEN=$((MAX_SEQ_LENGTH * 2))
INFER_MAX_TOKEN_LEN=$((MAX_SEQ_LENGTH * 2))
...
python3 -m axon.driver.train_agent_ppo \
    ...
    actor.megatron.tensor_model_parallel_size=8 \
    ...
    sampler.tensor_model_parallel_size=4 \
